            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input name="departureDate" id="departureDate" placeholder="2017-05-30" required pattern="[0-9]{4}-[0-1]{1}[0-9]{1}-[0-3]{1}[0-9]{1}"></td>
                    </tr>
                    <tr>
                        <td><label class="field" for="returnDate">Return date: </label></td>
                        <td><input name="returnDate" placeholder="2017-06-03" required pattern="[0-9]{4}-[0-1]{1}[0-9]{1}-[0-3]{1}[0-9]{1}"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
