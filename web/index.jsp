        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="date" name="departureDate" id="departureDate" value="30/0/2017" required pattern="[0-3]{1}[0-9]{1}/[0-1]{1}[0-9]{1}/[0-9]{4}"></td>
                </tr>
                <tr>
                    <td><label class="field" for="returnDate">Return date: </label></td>
                    <td><input type="date" name="returnDate" value="30/0/2017" required pattern="[0-3]{1}[0-9]{1}/[0-1]{1}[0-9]{1}/[0-9]{4}"></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
